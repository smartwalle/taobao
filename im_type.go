...
type openIMPushMsgRsp struct {
	Rsp *OpenIMPushMsgRsp `json:"openim_immsg_push_response"`
	Err *ErrorResponse    `json:"error_response"`
}
...
type openIMPushCustomMsgRsp struct {
	Rsp *OpenIMPushMsgRsp `json:"openim_custmsg_push_response"`
	Err *ErrorResponse    `json:"error_response"`
}
...
type TribeInfo struct {
	...
	RecvFlag  int    `json:"recv_flag"`
	Notice    string `json:"notice"`
}

type openIMCreateTribeRsp struct {
	Rsp struct {
		TribeInfo *TribeInfo `json:"tribe_info"`
...
type openIMGetTribeInfoRsp struct {
	Rsp struct {
		TribeInfo *TribeInfo `json:"tribe_info"`
